...
import {ProfileStatistics, StatisticsService} from "../api";
...
export default function ProfileStudent() {
    const [statistic, setStatistic] = useState<ProfileStatistics | null>(null);
    ...
    //                     completed questions: {chapter.completed}</div>
    //                 <div
    ...
    //                 </div>
    //             </div>
    //             <Progress size="md" color={getColor(chapter.percentage)} aria-label="Loading..."
    ...
    //                 <div
    //                     className="basis-1/2 text-center border border-slate-600 border-e-medium p-2 bg-slate-800">Total
    //                     completed questions: {skill.completed}</div>
    //                 <div
    //                     className="basis-1/2 text-center border border-slate-600 border-e-medium p-2 bg-slate-800">Average
    //                     percentage: {skill.percentage}%
    //                 </div>
    //             </div>
    //             <Progress size="md" color={getColor(skill.percentage)} aria-label="Loading..."
